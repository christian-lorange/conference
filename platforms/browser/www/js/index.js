...
function get() {
	// Get item from local storage and put inside variable.
	var itemToGet = localStorage.getItem('text');
	
	// Set value of textbox to what was retrieved from local storage.
	$('#get').val(itemToGet);
}